...
//        tank.clean();
    ...
    public ActionField() throws Exception {
        ...
        agressor = new Agressor(Integer.parseInt(position.substring(0, position.indexOf("_"))), Integer.parseInt(position.substring(position.lastIndexOf("_") + 1, position.length())), Direction.LEFT, this, battleField);
