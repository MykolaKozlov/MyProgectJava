package SixLesson.Chapter_3_Task_4;
...
public class Shop {
    ...
    public String[] transactionsDuringTheDay(String date) {
        ...
        for (int i = 0; i < purchaseArchive[Integer.parseInt(date.substring(0, date.indexOf(";")))][Integer.parseInt(date.substring(date.indexOf(";") + 1, date.length()))].length; i++) {
            if (findDayOnPurchaseArchive(date, i) != null) {
                ...
                str[1] = findDayOnPurchaseArchive(date, i).getFullName();
                str[2] = findDayOnPurchaseArchive(date, i).getMotorcycle().getMotorcycleBrand().toString();
                str[3] = Integer.toString((int) findDayOnPurchaseArchive(date, i).getPrice());
                str[4] = Integer.toString(findDayOnPurchaseArchive(date, i).getQuantity());
